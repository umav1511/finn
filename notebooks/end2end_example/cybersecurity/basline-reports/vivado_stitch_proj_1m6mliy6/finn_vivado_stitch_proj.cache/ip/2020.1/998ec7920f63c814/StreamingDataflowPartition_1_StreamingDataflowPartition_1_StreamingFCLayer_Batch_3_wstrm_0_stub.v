...
/* synthesis syn_black_box black_box_pad_pin="aclk,aresetn,awready,awvalid,awaddr[7:0],awprot[2:0],wready,wvalid,wdata[31:0],wstrb[3:0],bready,bvalid,bresp[1:0],arready,arvalid,araddr[7:0],arprot[2:0],rready,rvalid,rresp[1:0],rdata[31:0],m_axis_0_tready,m_axis_0_tvalid,m_axis_0_tdata[7:0]" */;
  input aclk;
  input aresetn;
  output awready;
  input awvalid;
