...
(* CORE_GENERATION_INFO="StreamingFCLayer_Batch_1_StreamingFCLayer_Batch_1,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.407000,HLS_SYN_LAT=70,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=570,HLS_SYN_LUT=1788,HLS_VERSION=2020_1}" *)
...
reg weights_V_V_TREADY;
 ...
 reg    ap_rst_n_inv;
wire    grp_Matrix_Vector_Activa_fu_52_ap_start;
wire    grp_Matrix_Vector_Activa_fu_52_ap_done;
wire    grp_Matrix_Vector_Activa_fu_52_ap_idle;
wire    grp_Matrix_Vector_Activa_fu_52_ap_ready;
wire    grp_Matrix_Vector_Activa_fu_52_in_V_V_TREADY;
wire   [7:0] grp_Matrix_Vector_Activa_fu_52_out_V_V_TDATA;
wire    grp_Matrix_Vector_Activa_fu_52_out_V_V_TVALID;
wire    grp_Matrix_Vector_Activa_fu_52_out_V_V_TREADY;
wire    grp_Matrix_Vector_Activa_fu_52_weight_V_V_TREADY;
reg    grp_Matrix_Vector_Activa_fu_52_ap_start_reg;
...
initial begin
#0 grp_Matrix_Vector_Activa_fu_52_ap_start_reg = 1'b0;
#0 ap_CS_fsm = 4'd1;
end

StreamingFCLayer_Batch_1_Matrix_Vector_Activa grp_Matrix_Vector_Activa_fu_52(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(grp_Matrix_Vector_Activa_fu_52_ap_start),
    .ap_done(grp_Matrix_Vector_Activa_fu_52_ap_done),
    .ap_idle(grp_Matrix_Vector_Activa_fu_52_ap_idle),
    .ap_ready(grp_Matrix_Vector_Activa_fu_52_ap_ready),
    .in_V_V_TDATA(in0_V_V_TDATA_int),
    .in_V_V_TVALID(in0_V_V_TVALID_int),
    .in_V_V_TREADY(grp_Matrix_Vector_Activa_fu_52_in_V_V_TREADY),
    .out_V_V_TDATA(grp_Matrix_Vector_Activa_fu_52_out_V_V_TDATA),
    .out_V_V_TVALID(grp_Matrix_Vector_Activa_fu_52_out_V_V_TVALID),
    .out_V_V_TREADY(grp_Matrix_Vector_Activa_fu_52_out_V_V_TREADY),
    .weight_V_V_TDATA(weights_V_V_TDATA_int),
    .weight_V_V_TVALID(weights_V_V_TVALID_int),
    .weight_V_V_TREADY(grp_Matrix_Vector_Activa_fu_52_weight_V_V_TREADY)
);
...
regslice_both_out_V_V_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .data_in(grp_Matrix_Vector_Activa_fu_52_out_V_V_TDATA),
    .vld_in(grp_Matrix_Vector_Activa_fu_52_out_V_V_TVALID),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_Matrix_Vector_Activa_fu_52_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state2)) begin
            grp_Matrix_Vector_Activa_fu_52_ap_start_reg <= 1'b1;
        end else if ((grp_Matrix_Vector_Activa_fu_52_ap_ready == 1'b1)) begin
            grp_Matrix_Vector_Activa_fu_52_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        in0_V_V_TREADY_int = grp_Matrix_Vector_Activa_fu_52_in_V_V_TREADY;
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        weights_V_V_TREADY_int = grp_Matrix_Vector_Activa_fu_52_weight_V_V_TREADY;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_Matrix_Vector_Activa_fu_52_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign grp_Matrix_Vector_Activa_fu_52_ap_start = grp_Matrix_Vector_Activa_fu_52_ap_start_reg;

assign grp_Matrix_Vector_Activa_fu_52_out_V_V_TREADY = (out_V_V_TREADY_int & ap_CS_fsm_state3);
