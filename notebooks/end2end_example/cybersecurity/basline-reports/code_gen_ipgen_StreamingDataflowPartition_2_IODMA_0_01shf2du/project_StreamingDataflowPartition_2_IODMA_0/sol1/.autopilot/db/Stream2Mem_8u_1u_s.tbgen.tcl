set moduleName Stream2Mem_8u_1u_s
set isTopModule 0
...
set C_modelName {Stream2Mem<8u, 1u>}
...
set portList { 
	...
	{ in_V_V_TDATA_blk_n sc_out sc_logic 1 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_V_V_TDATA_blk_n", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_V_V_TDATA_blk_n", "role": "default" }} , 
...
set Spec2ImplPortList { 
	in_V_V { axis {  { in_V_V_TVALID in_vld 0 1 }  { in_V_V_TDATA in_data 0 8 }  { in_V_V_TREADY in_acc 1 1 } } }
