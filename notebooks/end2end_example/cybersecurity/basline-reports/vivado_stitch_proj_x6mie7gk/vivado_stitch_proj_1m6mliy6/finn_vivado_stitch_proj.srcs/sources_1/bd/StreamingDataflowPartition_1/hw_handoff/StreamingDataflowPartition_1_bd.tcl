...
proc create_hier_cell_StreamingDataflowPartition_1_StreamingFCLayer_Batch_3 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {64} \
   CONFIG.MEM_INIT {/tmp/finn_dev_uma/code_gen_ipgen_StreamingFCLayer_Batch_3_a9whvd4t/} \
   CONFIG.MEM_WIDTH {8} \
   CONFIG.NSTREAMS {1} \
...
proc create_hier_cell_StreamingDataflowPartition_1_StreamingFCLayer_Batch_2 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {64} \
   CONFIG.MEM_INIT {/tmp/finn_dev_uma/code_gen_ipgen_StreamingFCLayer_Batch_2_908v5i3j/} \
...
proc create_hier_cell_StreamingDataflowPartition_1_StreamingFCLayer_Batch_1 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {64} \
   CONFIG.MEM_INIT {/tmp/finn_dev_uma/code_gen_ipgen_StreamingFCLayer_Batch_1_qppq8t4w/} \
   CONFIG.MEM_WIDTH {128} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
   CONFIG.STRM0_DEPTH {64} \
...
proc create_hier_cell_StreamingDataflowPartition_1_StreamingFCLayer_Batch_0 { parentCell nameHier } {
  ...
  set_property -dict [ list \
   CONFIG.MEM_DEPTH {80} \
   CONFIG.MEM_INIT {/tmp/finn_dev_uma/code_gen_ipgen_StreamingFCLayer_Batch_0_hjzgxsrx/} \
   CONFIG.MEM_WIDTH {960} \
   CONFIG.NSTREAMS {1} \
   CONFIG.RAM_STYLE {auto} \
   CONFIG.STRM0_DEPTH {80} \
   CONFIG.STRM0_OFFSET {0} \
   CONFIG.STRM0_WIDTH {960} \
...
proc create_root_design { parentCell } {
  ...
  set StreamingDataflowPartition_1_StreamingFIFO_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:StreamingFIFO_0:1.0 StreamingDataflowPartition_1_StreamingFIFO_0 ]
  ...
  connect_bd_intf_net -intf_net StreamingDataflowPartition_1_StreamingFCLayer_Batch_3_out_V_V [get_bd_intf_pins StreamingDataflowPartition_1_StreamingFCLayer_Batch_3/out_V_V] [get_bd_intf_pins StreamingDataflowPartition_1_StreamingFIFO_1/in0_V_V]
  connect_bd_intf_net -intf_net StreamingDataflowPartition_1_StreamingFIFO_0_out_V_V [get_bd_intf_pins StreamingDataflowPartition_1_StreamingFCLayer_Batch_0/in0_V_V] [get_bd_intf_pins StreamingDataflowPartition_1_StreamingFIFO_0/out_V_V]
