...
wire   [31:0] p_Result_s_fu_111_p3;
reg   [31:0] p_Result_s_reg_170;
wire   [0:0] icmp_ln517_fu_125_p2;
wire   [23:0] trunc_ln_fu_146_p3;
...
assign icmp_ln508_fu_96_p2 = ((t_0_reg_80 == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln517_fu_125_p2 = ((i_fu_119_p2 == 32'd4) ? 1'b1 : 1'b0);

assign out_V_V_TDATA = p_Result_s_reg_170;

assign p_Result_s_fu_111_p3 = {{in_V_V_TDATA}, {r_V_reg_69}};

assign t_fu_102_p2 = (t_0_reg_80 + 5'd1);

assign tmp_1_fu_136_p4 = {{r_V_reg_69[23:8]}};
