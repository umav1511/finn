...
struct StreamingDataflowPartition_0_IODMA_0_StreamingDataflowPartition_0_IODMA_0 : public sc_module {
    ...
    sc_signal< sc_lv<16> > Mem2Stream_Batch_U0_m_axi_in_V_WDATA;
    sc_signal< sc_lv<2> > Mem2Stream_Batch_U0_m_axi_in_V_WSTRB;
    ...
    sc_signal< sc_lv<16> > Mem2Stream_Batch_U0_out_V_V_TDATA;
