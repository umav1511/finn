...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "enable_clock"
...
proc update_PARAM_VALUE.enable_clock { PARAM_VALUE.enable_clock } {
	# Procedure called to update enable_clock when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.enable_clock { PARAM_VALUE.enable_clock } {
	# Procedure called to validate enable_clock
	return true
}
